...
const Slider = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React.createElement(
  ...
  /* @__PURE__ */ React.createElement(SliderPrimitive.Track, { className: "relative h-2 w-full grow overflow-hidden rounded-full bg-secondary" }, /* @__PURE__ */ React.createElement(SliderPrimitive.Range, { className: "absolute h-full bg-primary" })),
